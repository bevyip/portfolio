...
const allPlayPositions = {
  ...
  "puzzle-feeder": { col: 1, rowStart: 13, rowEnd: 14 },
  ...
  "black-market": { col: 2, rowStart: 12, rowEnd: 14 },
  ...
  "image-to-sprite": { col: 3, rowStart: 9, rowEnd: 11 },
  "five-identical-fishes": { col: 3, rowStart: 11, rowEnd: 12 },
