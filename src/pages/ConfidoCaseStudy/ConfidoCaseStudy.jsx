  ...
  return (
    <div className="confido-case-study">
      ...
      <CaseStudyLayout projectId="confido">
        ...
        <section id="confido-context" className="confido-context-section">
          <div className="confido-context-content">
            ...
            <div className="confido-context-top">
              <div
                className="confido-context-item"
                ref={contextWhatIsConfidoRef}
              >
                <h2 className="confido-context-title">What is Confido?</h2>
                <p className="confido-context-description">
                  Confido is a B2B SaaS platform that helps CPG brands manage
                  and resolve promotional deductions and chargebacks. The
                  platform streamlines the complex process of reviewing,
                  approving, and disputing promotional claims between retailers
                  and suppliers.
                </p>
              </div>
              <div className="confido-context-item" ref={contextMyRoleRef}>
                ...
                <p className="confido-context-description">
                  As Confido's only designer, I owned this 0→1 redesign end to
                  end — designing in Figma and shipping the implementation in
                  production. I conducted user research with accounting teams at
                  brands like Olipop and Unbun Foods, analyzed competitors, and
                  built the entire new workflow system that went live to users.
                </p>
              </div>
            </div>
            ...
            <div className="confido-context-statement">
              ...
              <CaseStudyStatement ref={contextStatementContentRef}>
                ...
                <CaseStudyStatementBody>
                  The existing approval system caused <i>35% of deductions</i>{" "}
                  to cycle back for reviews, creating costly delays across the
                  organization.
                </CaseStudyStatementBody>
              </CaseStudyStatement>
              <div
          ...
          <div className="confido-research-content">
            ...
            <div className="confido-research-finding">
              ...
              >
                ...
                <CaseStudyStatementBody>
                  After analyzing how competitors approached approval workflows,
                  I realized{" "}
                  <span style={{ fontWeight: 600 }}>
        ...
        {/* Design Approach Section */}
        <section
          id="confido-design-approach"
          className="confido-design-approach-section"
        >
            ...
            <div className="confido-design-approach-item">
              ...
              >
                ...
                <CaseStudyStatementBody>
                  ...
                  modals to{" "}
                  <span style={{ fontWeight: 600 }}>
                    its own dedicated section with full navigation and
                    visibility
                  </span>
                  .
                </CaseStudyStatementBody>
            ...
            <div className="confido-design-approach-item">
              ...
              >
                ...
                <CaseStudyStatementBody>
                  ...
                  stakeholders, I iterated my designs over 4 critical areas
        ...
        <section id="solution-section" className="confido-solution-section">
          <div className="confido-solution-content">
            ...
            <div className="confido-solution-item">
              <h4
                className="confido-solution-item-title"
              ...
              <div className="confido-solution-media">
                ...
                <p
                  className="confido-solution-caption"
                  ref={solution1CaptionRef}
                >
                  The dedicated approval section reduced navigation from{" "}
                  <span style={{ fontWeight: 600 }}>5+ clicks to 1</span>,
                  cutting discovery time by{" "}
            ...
            <div className="confido-solution-item">
              ...
              <div className="confido-solution-media">
                ...
                <p
                  className="confido-solution-caption"
                  ref={solution4CaptionRef}
                >
                  <span style={{ fontWeight: 600 }}>
                    Clear misassignment handling
                  </span>{" "}
                  eliminated the confusion that caused 35% of deductions to
                  cycle back for multiple reviews.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="confido-reflection-content">
            ...
            <div className="confido-reflection-item" ref={reflectionContentRef}>
              <h4 className="confido-reflection-title-text">
                This was my first design role as Confido's only designer,
                handling both product design and engineering.
              </h4>
              <p className="confido-reflection-description">
                Without design mentorship in an unfamiliar domain (CPG brands)
                and learning Ruby on the fly, I had to define my own pace and
                trust my instincts—a stark shift from structured internships.
                Collaborating directly with engineering and customer success
                also taught me to communicate design decisions effectively and
                gave me genuine input on product direction. This environment
                proved I could bridge design and engineering while delivering a
                complete 0→1 overhaul.{" "}
